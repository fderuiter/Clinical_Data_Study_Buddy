...
import pandas as pd
from cdisc_data_symphony.core.generation_service import generate_cdash_crf

@patch('cdisc_data_symphony.core.generation_service.load_ig')
@patch('cdisc_data_symphony.core.generation_service.build_domain_crf')
def test_generate_cdash_crf_with_directory_as_config(mock_build_domain_crf, mock_load_ig, tmp_path):
    """
