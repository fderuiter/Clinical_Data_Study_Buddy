...
class TestGenerateCli(unittest.TestCase):
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_tfl_shell")
    def test_tfl_shell_success(self, mock_generate_tfl_shell):
        ...
        # Act
        result = self.runner.invoke(generate_app, ["tfl-shell", "--spec", spec, "--output-file", output_file])

        # Assert
        self.assertEqual(result.exit_code, 0)
        self.assertIn(f"Successfully generated TFL shell in {output_file}", result.stdout)
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_edc_raw_dataset_package")
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_synthetic_data")
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_analysis_code")
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_cdash_crf")
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_study_protocols")
    ...
    @patch("clinical_data_study_buddy.cli.commands.generate.generation_service.generate_specification_templates")
