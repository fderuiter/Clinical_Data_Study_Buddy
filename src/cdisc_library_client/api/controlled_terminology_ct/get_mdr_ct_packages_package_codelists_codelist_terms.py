...
from ...models.ct_codelist_terms import CtCodelistTerms
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/ct/packages/{package}/codelists/{codelist}/terms".format(
            package=package,
            codelist=codelist,
        ),
    }
...
) -> Optional[Union[CtCodelistTerms, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CtCodelistTerms.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CtCodelistTerms, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CtCodelistTerms, DefaultErrorResponse]
    """
