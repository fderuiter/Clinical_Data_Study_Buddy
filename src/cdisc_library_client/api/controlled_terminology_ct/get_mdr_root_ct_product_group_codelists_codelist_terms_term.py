...
from ...models.root_ct_term import RootCtTerm
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/root/ct/{product_group}/codelists/{codelist}/terms/{term}".format(
...
) -> Optional[Union[DefaultErrorResponse, RootCtTerm]]:
    if response.status_code == 200:
        response_200 = RootCtTerm.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, RootCtTerm]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, RootCtTerm]
    """
