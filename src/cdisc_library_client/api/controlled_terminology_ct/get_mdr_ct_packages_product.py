...
from ...models.ct_package import CtPackage
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/ct/packages/{product}".format(
            product=product,
        ),
    }
...
) -> Optional[Union[CtPackage, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CtPackage.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CtPackage, DefaultErrorResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        product (str):  Example: sdtmct-2019-12-20.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CtPackage, DefaultErrorResponse]
    """
