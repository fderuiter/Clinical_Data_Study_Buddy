...
from ...models.ct_term import CtTerm
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/ct/packages/{package}/codelists/{codelist}/terms/{term}".format(
            package=package,
            codelist=codelist,
            term=term,
        ),
...
) -> Optional[Union[CtTerm, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CtTerm.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CtTerm, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CtTerm, DefaultErrorResponse]
    """
