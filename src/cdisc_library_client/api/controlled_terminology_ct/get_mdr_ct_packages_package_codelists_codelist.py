...
from ...models.ct_codelist import CtCodelist
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/ct/packages/{package}/codelists/{codelist}".format(
            package=package,
            codelist=codelist,
        ),
    }
...
) -> Optional[Union[CtCodelist, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CtCodelist.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CtCodelist, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CtCodelist, DefaultErrorResponse]
    """
