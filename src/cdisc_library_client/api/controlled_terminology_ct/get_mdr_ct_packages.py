...
from ...models.ct_packages import CtPackages
...
) -> Optional[Union[CtPackages, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CtPackages.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CtPackages, DefaultErrorResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CtPackages, DefaultErrorResponse]
    """
