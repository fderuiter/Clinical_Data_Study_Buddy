...
) -> Optional[Union[DefaultErrorResponse, ProductgroupDataCollection]]:
    if response.status_code == 200:
        response_200 = ProductgroupDataCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, ProductgroupDataCollection]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, ProductgroupDataCollection]
    """
