...
) -> Optional[Union[DefaultErrorResponse, ProductgroupQrs]]:
    if response.status_code == 200:
        response_200 = ProductgroupQrs.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, ProductgroupQrs]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, ProductgroupQrs]
    """
