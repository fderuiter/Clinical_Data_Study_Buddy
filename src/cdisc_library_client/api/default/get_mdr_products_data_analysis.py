...
) -> Optional[Union[DefaultErrorResponse, ProductgroupDataAnalysis]]:
    if response.status_code == 200:
        response_200 = ProductgroupDataAnalysis.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, ProductgroupDataAnalysis]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, ProductgroupDataAnalysis]
    """
