...
) -> Optional[Union[DefaultErrorResponse, ProductgroupDataTabulation]]:
    if response.status_code == 200:
        response_200 = ProductgroupDataTabulation.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, ProductgroupDataTabulation]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, ProductgroupDataTabulation]
    """
