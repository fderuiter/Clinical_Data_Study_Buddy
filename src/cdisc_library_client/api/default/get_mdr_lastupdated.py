...
from ...models.lastupdated import Lastupdated
...
) -> Optional[Union[DefaultErrorResponse, Lastupdated]]:
    if response.status_code == 200:
        response_200 = Lastupdated.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, Lastupdated]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, Lastupdated]
    """
