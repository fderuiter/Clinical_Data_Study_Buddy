...
) -> Optional[Union[DefaultErrorResponse, ProductgroupTerminology]]:
    if response.status_code == 200:
        response_200 = ProductgroupTerminology.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, ProductgroupTerminology]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, ProductgroupTerminology]
    """
