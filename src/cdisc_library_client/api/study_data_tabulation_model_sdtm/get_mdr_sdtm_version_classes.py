...
from ...models.sdtm_classes import SdtmClasses
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/classes".format(
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmClasses]]:
    if response.status_code == 200:
        response_200 = SdtmClasses.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmClasses]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmClasses]
    """
