...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/datasets/{dataset}".format(
            version=version,
            dataset=dataset,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmDataset]]:
    if response.status_code == 200:
        response_200 = SdtmDataset.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmDataset]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmDataset]
    """
