...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/classes/{class_}".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmClass]]:
    if response.status_code == 200:
        response_200 = SdtmClass.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmClass]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmClass]
    """
