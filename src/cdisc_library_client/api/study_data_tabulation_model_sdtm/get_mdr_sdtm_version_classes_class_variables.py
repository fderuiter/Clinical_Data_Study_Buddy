...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/classes/{class_}/variables".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmClassVariables]]:
    if response.status_code == 200:
        response_200 = SdtmClassVariables.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmClassVariables]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmClassVariables]
    """
