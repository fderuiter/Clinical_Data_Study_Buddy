...
from ...models.root_sdtm_dataset_variable import RootSdtmDatasetVariable
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/root/sdtm/datasets/{dataset}/variables/{var}".format(
            dataset=dataset,
            var=var,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, RootSdtmDatasetVariable]]:
    if response.status_code == 200:
        response_200 = RootSdtmDatasetVariable.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, RootSdtmDatasetVariable]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, RootSdtmDatasetVariable]
    """
