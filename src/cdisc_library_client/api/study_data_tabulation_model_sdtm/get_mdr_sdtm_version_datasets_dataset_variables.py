...
from ...models.sdtm_dataset_variables import SdtmDatasetVariables
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/datasets/{dataset}/variables".format(
            version=version,
            dataset=dataset,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmDatasetVariables]]:
    if response.status_code == 200:
        response_200 = SdtmDatasetVariables.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmDatasetVariables]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmDatasetVariables]
    """
