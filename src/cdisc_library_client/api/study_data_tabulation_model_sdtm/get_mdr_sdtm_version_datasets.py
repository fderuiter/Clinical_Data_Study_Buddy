...
from ...models.sdtm_datasets import SdtmDatasets
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/datasets".format(
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmDatasets]]:
    if response.status_code == 200:
        response_200 = SdtmDatasets.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmDatasets]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmDatasets]
    """
