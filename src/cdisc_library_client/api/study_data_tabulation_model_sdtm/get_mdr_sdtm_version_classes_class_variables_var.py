...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtm/{version}/classes/{class_}/variables/{var}".format(
            version=version,
            class_=class_,
            var=var,
        ),
...
) -> Optional[Union[DefaultErrorResponse, SdtmClassVariable]]:
    if response.status_code == 200:
        response_200 = SdtmClassVariable.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmClassVariable]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmClassVariable]
    """
