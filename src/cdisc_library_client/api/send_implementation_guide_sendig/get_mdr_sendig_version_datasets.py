...
) -> Optional[Union[DefaultErrorResponse, SendigDatasets]]:
    if response.status_code == 200:
        response_200 = SendigDatasets.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigDatasets]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigDatasets]
    """
