...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sendig/{version}/datasets/{dataset}/variables/{var}".format(
            version=version,
            dataset=dataset,
            var=var,
        ),
...
) -> Optional[Union[DefaultErrorResponse, SendigDatasetVariable]]:
    if response.status_code == 200:
        response_200 = SendigDatasetVariable.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigDatasetVariable]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigDatasetVariable]
    """
