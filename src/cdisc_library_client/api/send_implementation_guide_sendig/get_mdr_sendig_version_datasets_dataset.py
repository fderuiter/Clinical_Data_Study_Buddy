...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sendig/{version}/datasets/{dataset}".format(
            version=version,
            dataset=dataset,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SendigDataset]]:
    if response.status_code == 200:
        response_200 = SendigDataset.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigDataset]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigDataset]
    """
