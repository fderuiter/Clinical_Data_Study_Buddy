...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sendig/{version}/classes/{class_}".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SendigClass]]:
    if response.status_code == 200:
        response_200 = SendigClass.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigClass]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigClass]
    """
