...
from ...models.sendig_classes import SendigClasses
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sendig/{version}/classes".format(
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SendigClasses]]:
    if response.status_code == 200:
        response_200 = SendigClasses.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigClasses]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigClasses]
    """
