...
from ...models.sendig_product import SendigProduct
...
) -> Optional[Union[DefaultErrorResponse, SendigProduct]]:
    if response.status_code == 200:
        response_200 = SendigProduct.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SendigProduct]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SendigProduct]
    """
