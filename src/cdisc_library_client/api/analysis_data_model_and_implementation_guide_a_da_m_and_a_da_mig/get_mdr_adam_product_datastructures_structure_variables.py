...
from ...models.adam_datastructure_variables import AdamDatastructureVariables
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/adam/{product}/datastructures/{structure}/variables".format(
            product=product,
            structure=structure,
        ),
    }
...
) -> Optional[Union[AdamDatastructureVariables, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = AdamDatastructureVariables.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AdamDatastructureVariables, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AdamDatastructureVariables, DefaultErrorResponse]
    """
