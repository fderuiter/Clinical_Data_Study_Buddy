...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/adam/{product}/datastructures/{structure}".format(
            product=product,
            structure=structure,
        ),
    }
...
) -> Optional[Union[AdamDatastructure, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = AdamDatastructure.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AdamDatastructure, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AdamDatastructure, DefaultErrorResponse]
    """
