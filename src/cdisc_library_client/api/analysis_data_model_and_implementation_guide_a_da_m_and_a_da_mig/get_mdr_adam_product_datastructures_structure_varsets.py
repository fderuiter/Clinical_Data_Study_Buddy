...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/adam/{product}/datastructures/{structure}/varsets".format(
            product=product,
            structure=structure,
        ),
    }
...
) -> Optional[Union[AdamDatastructureVarsets, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = AdamDatastructureVarsets.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AdamDatastructureVarsets, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AdamDatastructureVarsets, DefaultErrorResponse]
    """
