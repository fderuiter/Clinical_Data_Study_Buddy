...
from ...models.adam_product_datastructures import AdamProductDatastructures
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/adam/{product}/datastructures".format(
            product=product,
        ),
    }
...
) -> Optional[Union[AdamProductDatastructures, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = AdamProductDatastructures.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AdamProductDatastructures, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AdamProductDatastructures, DefaultErrorResponse]
    """
