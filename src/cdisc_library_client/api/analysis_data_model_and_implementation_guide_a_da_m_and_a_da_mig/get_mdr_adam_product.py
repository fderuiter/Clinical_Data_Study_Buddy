...
from ...models.adam_product import AdamProduct
...
) -> Optional[Union[AdamProduct, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = AdamProduct.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AdamProduct, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AdamProduct, DefaultErrorResponse]
    """
