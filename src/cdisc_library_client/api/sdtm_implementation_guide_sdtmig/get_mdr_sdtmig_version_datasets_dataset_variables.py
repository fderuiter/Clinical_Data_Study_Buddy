...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtmig/{version}/datasets/{dataset}/variables".format(
            version=version,
            dataset=dataset,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmigDatasetVariables]]:
    if response.status_code == 200:
        response_200 = SdtmigDatasetVariables.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigDatasetVariables]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigDatasetVariables]
    """
