...
from ...models.sdtmig_class_datasets import SdtmigClassDatasets
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtmig/{version}/classes/{class_}/datasets".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmigClassDatasets]]:
    if response.status_code == 200:
        response_200 = SdtmigClassDatasets.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigClassDatasets]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigClassDatasets]
    """
