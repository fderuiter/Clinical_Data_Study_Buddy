...
from ...models.sdtmig_datasets import SdtmigDatasets
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtmig/{version}/datasets".format(
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmigDatasets]]:
    if response.status_code == 200:
        response_200 = SdtmigDatasets.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigDatasets]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigDatasets]
    """
