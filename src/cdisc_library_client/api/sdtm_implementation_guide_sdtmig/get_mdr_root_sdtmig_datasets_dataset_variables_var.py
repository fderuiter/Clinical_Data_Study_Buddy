...
from ...models.root_sdtmig_dataset_variable import RootSdtmigDatasetVariable
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/root/sdtmig/datasets/{dataset}/variables/{var}".format(
            dataset=dataset,
            var=var,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, RootSdtmigDatasetVariable]]:
    if response.status_code == 200:
        response_200 = RootSdtmigDatasetVariable.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, RootSdtmigDatasetVariable]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataset (str):  Example: DM.
        var (str):  Example: SUBJID.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, RootSdtmigDatasetVariable]
    """
