...
) -> Optional[Union[DefaultErrorResponse, SdtmigDatasetVariable]]:
    if response.status_code == 200:
        response_200 = SdtmigDatasetVariable.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigDatasetVariable]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigDatasetVariable]
    """
