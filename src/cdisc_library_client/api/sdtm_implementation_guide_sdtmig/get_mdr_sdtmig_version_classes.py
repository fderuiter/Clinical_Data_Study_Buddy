...
from ...models.sdtmig_classes import SdtmigClasses
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/sdtmig/{version}/classes".format(
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, SdtmigClasses]]:
    if response.status_code == 200:
        response_200 = SdtmigClasses.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigClasses]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigClasses]
    """
