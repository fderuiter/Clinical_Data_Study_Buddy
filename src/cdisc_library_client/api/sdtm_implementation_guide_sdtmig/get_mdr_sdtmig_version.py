...
from ...models.sdtmig_product import SdtmigProduct
...
) -> Optional[Union[DefaultErrorResponse, SdtmigProduct]]:
    if response.status_code == 200:
        response_200 = SdtmigProduct.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, SdtmigProduct]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, SdtmigProduct]
    """
