...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/qrs/{measure}/{version}/items".format(
            measure=measure,
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, QrsItems]]:
    if response.status_code == 200:
        response_200 = QrsItems.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, QrsItems]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, QrsItems]
    """
