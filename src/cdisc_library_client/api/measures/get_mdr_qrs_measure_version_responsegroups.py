...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/qrs/{measure}/{version}/responsegroups".format(
            measure=measure,
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, QrsResponsegroups]]:
    if response.status_code == 200:
        response_200 = QrsResponsegroups.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, QrsResponsegroups]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, QrsResponsegroups]
    """
