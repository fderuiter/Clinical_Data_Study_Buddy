...
from ...models.qrs_product import QrsProduct
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/qrs/{measure}/{version}".format(
            measure=measure,
            version=version,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, QrsProduct]]:
    if response.status_code == 200:
        response_200 = QrsProduct.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, QrsProduct]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, QrsProduct]
    """
