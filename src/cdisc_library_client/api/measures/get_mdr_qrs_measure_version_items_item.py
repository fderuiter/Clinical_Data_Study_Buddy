...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/qrs/{measure}/{version}/items/{item}".format(
            measure=measure,
            version=version,
            item=item,
        ),
...
) -> Optional[Union[DefaultErrorResponse, QrsItem]]:
    if response.status_code == 200:
        response_200 = QrsItem.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, QrsItem]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, QrsItem]
    """
