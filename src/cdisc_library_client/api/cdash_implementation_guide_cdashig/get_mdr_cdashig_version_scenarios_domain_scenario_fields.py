...
from ...models.cdashig_scenario_fields import CdashigScenarioFields
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/scenarios/{domain}.{scenario}/fields".format(
            version=version,
            domain=domain,
            scenario=scenario,
        ),
...
) -> Optional[Union[CdashigScenarioFields, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigScenarioFields.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigScenarioFields, DefaultErrorResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        scenario (str):  Example: HorizontalGeneric.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigScenarioFields, DefaultErrorResponse]
    """
