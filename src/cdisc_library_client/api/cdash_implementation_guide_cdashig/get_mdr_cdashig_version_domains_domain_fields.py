...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/domains/{domain}/fields".format(
            version=version,
            domain=domain,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CdashigDomainFields.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigDomainFields, DefaultErrorResponse]
    """
