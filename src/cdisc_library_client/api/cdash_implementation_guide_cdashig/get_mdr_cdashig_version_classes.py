...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/classes".format(
            version=version,
        ),
    }
...
) -> Optional[Union[CdashigProductClasses, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigProductClasses.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigProductClasses, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigProductClasses, DefaultErrorResponse]
    """
