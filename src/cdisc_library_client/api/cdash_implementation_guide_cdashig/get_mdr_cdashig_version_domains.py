...
from ...models.cdashig_product_domains import CdashigProductDomains
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/domains".format(
            version=version,
        ),
    }
...
) -> Optional[Union[CdashigProductDomains, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigProductDomains.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigProductDomains, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigProductDomains, DefaultErrorResponse]
    """
