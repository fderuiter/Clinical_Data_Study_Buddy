...
from ...models.root_cdashig_scenario_field import RootCdashigScenarioField
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/root/cdashig/scenarios/{domain}.{scenario}/fields/{field}".format(
            domain=domain,
            scenario=scenario,
            field=field,
        ),
...
) -> Optional[Union[DefaultErrorResponse, RootCdashigScenarioField]]:
    if response.status_code == 200:
        response_200 = RootCdashigScenarioField.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, RootCdashigScenarioField]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        scenario (str):  Example: Generic.
        field (str):  Example: VSDAT.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, RootCdashigScenarioField]
    """
