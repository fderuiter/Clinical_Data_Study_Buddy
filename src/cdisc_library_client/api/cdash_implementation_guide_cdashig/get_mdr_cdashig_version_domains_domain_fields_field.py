...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/domains/{domain}/fields/{field}".format(
            version=version,
            domain=domain,
            field=field,
        ),
...
) -> Optional[Union[CdashigDomainField, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigDomainField.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigDomainField, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigDomainField, DefaultErrorResponse]
    """
