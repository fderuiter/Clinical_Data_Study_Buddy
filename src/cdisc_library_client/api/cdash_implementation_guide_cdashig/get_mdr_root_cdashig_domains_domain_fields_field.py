...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/root/cdashig/domains/{domain}/fields/{field}".format(
            domain=domain,
            field=field,
        ),
    }
...
) -> Optional[Union[DefaultErrorResponse, RootCdashigDomainField]]:
    if response.status_code == 200:
        response_200 = RootCdashigDomainField.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultErrorResponse, RootCdashigDomainField]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultErrorResponse, RootCdashigDomainField]
    """
