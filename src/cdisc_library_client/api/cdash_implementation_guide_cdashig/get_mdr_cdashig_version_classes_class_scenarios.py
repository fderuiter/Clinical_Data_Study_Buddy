...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/classes/{class_}/scenarios".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[CdashigClassScenarios, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigClassScenarios.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigClassScenarios, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigClassScenarios, DefaultErrorResponse]
    """
