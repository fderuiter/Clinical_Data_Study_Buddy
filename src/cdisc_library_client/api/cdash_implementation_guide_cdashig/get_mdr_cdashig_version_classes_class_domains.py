...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/classes/{class_}/domains".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[CdashigClassDomains, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigClassDomains.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigClassDomains, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigClassDomains, DefaultErrorResponse]
    """
