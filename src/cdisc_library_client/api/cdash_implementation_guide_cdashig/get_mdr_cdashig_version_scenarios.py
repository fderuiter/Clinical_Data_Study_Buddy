...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdashig/{version}/scenarios".format(
            version=version,
        ),
    }
...
) -> Optional[Union[CdashigProductScenarios, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashigProductScenarios.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashigProductScenarios, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashigProductScenarios, DefaultErrorResponse]
    """
