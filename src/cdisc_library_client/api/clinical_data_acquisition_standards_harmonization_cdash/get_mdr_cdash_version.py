...
from ...models.cdash_product import CdashProduct
...
) -> Optional[Union[CdashProduct, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashProduct.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashProduct, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashProduct, DefaultErrorResponse]
    """
