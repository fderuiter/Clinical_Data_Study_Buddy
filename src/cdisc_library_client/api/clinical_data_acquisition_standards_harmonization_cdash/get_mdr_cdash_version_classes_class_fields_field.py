...
) -> Optional[Union[CdashClassField, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashClassField.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashClassField, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashClassField, DefaultErrorResponse]
    """
