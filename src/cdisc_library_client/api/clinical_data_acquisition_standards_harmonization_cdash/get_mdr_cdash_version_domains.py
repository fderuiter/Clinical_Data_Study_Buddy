...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdash/{version}/domains".format(
            version=version,
        ),
    }
...
) -> Optional[Union[CdashProductDomains, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashProductDomains.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashProductDomains, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashProductDomains, DefaultErrorResponse]
    """
