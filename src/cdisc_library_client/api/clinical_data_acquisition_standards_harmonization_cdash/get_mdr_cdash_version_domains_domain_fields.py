...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdash/{version}/domains/{domain}/fields".format(
            version=version,
            domain=domain,
        ),
    }
...
) -> Optional[Union[CdashDomainFields, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashDomainFields.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashDomainFields, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashDomainFields, DefaultErrorResponse]
    """
