...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdash/{version}/domains/{domain}".format(
            version=version,
            domain=domain,
        ),
    }
...
) -> Optional[Union[CdashDomain, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashDomain.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashDomain, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashDomain, DefaultErrorResponse]
    """
