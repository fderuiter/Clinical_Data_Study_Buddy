...
from ...models.cdash_product_classes import CdashProductClasses
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdash/{version}/classes".format(
            version=version,
        ),
    }
...
) -> Optional[Union[CdashProductClasses, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashProductClasses.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashProductClasses, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashProductClasses, DefaultErrorResponse]
    """
