...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mdr/cdash/{version}/classes/{class_}".format(
            version=version,
            class_=class_,
        ),
    }
...
) -> Optional[Union[CdashClass, DefaultErrorResponse]]:
    if response.status_code == 200:
        response_200 = CdashClass.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CdashClass, DefaultErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CdashClass, DefaultErrorResponse]
    """
