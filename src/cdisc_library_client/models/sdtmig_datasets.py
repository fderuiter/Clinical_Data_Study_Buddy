...
if TYPE_CHECKING:
    from ..models.sdtmig_datasets_links import SdtmigDatasetsLinks


T = TypeVar("T", bound="SdtmigDatasets")
...
class SdtmigDatasets:
    ...
    Attributes:
        ...
        source (Union[Unset, str]):  Example: CDISC Version 3.3 (v3.3) Study Data Tabulation Model Implementation Guide
            for Human Clinical Trials (SDTMIG) is intended to guide the organization, structure, and format of standard
            clinical trial tabulation datasets submitted to a regulatory authority..
        ...
        field_links (Union[Unset, SdtmigDatasetsLinks]):
    """
    ...
    field_links: Union[Unset, "SdtmigDatasetsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmigDatasetsLinks.from_dict(_field_links)
        ...
        sdtmig_datasets.additional_properties = d
