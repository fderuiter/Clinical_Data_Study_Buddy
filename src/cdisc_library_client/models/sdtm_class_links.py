...
if TYPE_CHECKING:
    ...
    from ..models.sdtm_class_ref_subclass import SdtmClassRefSubclass
    from ..models.sdtm_product_ref import SdtmProductRef


T = TypeVar("T", bound="SdtmClassLinks")
...
class SdtmClassLinks:
    """
    Attributes:
        self_ (Union[Unset, SdtmClassRef]):
        parent_product (Union[Unset, SdtmProductRef]):
        parent_class (Union[Unset, SdtmClassRef]):
        subclasses (Union[Unset, list['SdtmClassRefSubclass']]):
        prior_version (Union[Unset, SdtmClassRef]):
    """

    self_: Union[Unset, "SdtmClassRef"] = UNSET
    parent_product: Union[Unset, "SdtmProductRef"] = UNSET
    parent_class: Union[Unset, "SdtmClassRef"] = UNSET
    subclasses: Union[Unset, list["SdtmClassRefSubclass"]] = UNSET
    prior_version: Union[Unset, "SdtmClassRef"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmClassRef.from_dict(_self_)
        ...
        for subclasses_item_data in _subclasses or []:
            subclasses_item = SdtmClassRefSubclass.from_dict(subclasses_item_data)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmClassRef.from_dict(_prior_version)

        sdtm_class_links = cls(
            self_=self_,
        ...
        sdtm_class_links.additional_properties = d
        return sdtm_class_links
