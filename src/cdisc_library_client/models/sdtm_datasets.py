...
if TYPE_CHECKING:
    from ..models.sdtm_datasets_links import SdtmDatasetsLinks


T = TypeVar("T", bound="SdtmDatasets")
...
class SdtmDatasets:
    ...
    Attributes:
        ...
        field_links (Union[Unset, SdtmDatasetsLinks]):
    """
    ...
    field_links: Union[Unset, "SdtmDatasetsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmDatasetsLinks.from_dict(_field_links)
        ...
        sdtm_datasets.additional_properties = d
