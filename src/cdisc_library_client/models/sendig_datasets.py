...
if TYPE_CHECKING:
    from ..models.sendig_datasets_links import SendigDatasetsLinks


T = TypeVar("T", bound="SendigDatasets")


@_attrs_define
class SendigDatasets:
    """
    Attributes:
        ...
        field_links (Union[Unset, SendigDatasetsLinks]):
    """
    ...
    field_links: Union[Unset, "SendigDatasetsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SendigDatasetsLinks.from_dict(_field_links)
        ...
        sendig_datasets.additional_properties = d
