...
T = TypeVar("T", bound="CdashigScenarioFieldRefVersion")


@_attrs_define
class CdashigScenarioFieldRefVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cdashig_scenario_field_ref_version = cls(
            href=href,
            title=title,
            type_=type_,
        )

        cdashig_scenario_field_ref_version.additional_properties = d
