...
if TYPE_CHECKING:
    from ..models.cdashig_class_scenarios_links import CdashigClassScenariosLinks


T = TypeVar("T", bound="CdashigClassScenarios")
...
class CdashigClassScenarios:
    ...
    Attributes:
        ...
        field_links (Union[Unset, CdashigClassScenariosLinks]):
    """
    ...
    field_links: Union[Unset, "CdashigClassScenariosLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashigClassScenariosLinks.from_dict(_field_links)

        cdashig_class_scenarios = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        cdashig_class_scenarios.additional_properties = d
