...
T = TypeVar("T", bound="SdtmDatasetLinks")
...
class SdtmDatasetLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmDatasetRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmDatasetRef.from_dict(_prior_version)

        sdtm_dataset_links = cls(
            self_=self_,
        ...
        sdtm_dataset_links.additional_properties = d
        return sdtm_dataset_links
