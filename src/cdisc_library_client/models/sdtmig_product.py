...
if TYPE_CHECKING:
    from ..models.sdtmig_class import SdtmigClass
    from ..models.sdtmig_product_links import SdtmigProductLinks


T = TypeVar("T", bound="SdtmigProduct")
...
class SdtmigProduct:
    ...
    Attributes:
        ...
        field_links (Union[Unset, SdtmigProductLinks]):
        classes (Union[Unset, list['SdtmigClass']]):
    """
    ...
    field_links: Union[Unset, "SdtmigProductLinks"] = UNSET
    classes: Union[Unset, list["SdtmigClass"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmigProductLinks.from_dict(_field_links)

        classes = []
        _classes = d.pop("classes", UNSET)
        for classes_item_data in _classes or []:
            classes_item = SdtmigClass.from_dict(classes_item_data)
        ...
        sdtmig_product.additional_properties = d
