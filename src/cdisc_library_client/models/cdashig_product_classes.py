...
if TYPE_CHECKING:
    from ..models.cdashig_product_classes_links import CdashigProductClassesLinks


T = TypeVar("T", bound="CdashigProductClasses")
...
class CdashigProductClasses:
    ...
    Attributes:
        ...
        field_links (Union[Unset, CdashigProductClassesLinks]):
    """
    ...
    field_links: Union[Unset, "CdashigProductClassesLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashigProductClassesLinks.from_dict(_field_links)

        cdashig_product_classes = cls(
            name=name,
            label=label,
        ...
        cdashig_product_classes.additional_properties = d
