...
T = TypeVar("T", bound="ExportSendigDatasetsRow")
...
class ExportSendigDatasetsRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_sendig_datasets_row = cls(
            version=version,
            class_=class_,
        ...
        export_sendig_datasets_row.additional_properties = d
        return export_sendig_datasets_row
