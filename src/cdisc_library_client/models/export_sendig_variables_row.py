...
T = TypeVar("T", bound="ExportSendigVariablesRow")
...
class ExportSendigVariablesRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_sendig_variables_row = cls(
            version=version,
        ...
        export_sendig_variables_row.additional_properties = d
        return export_sendig_variables_row
