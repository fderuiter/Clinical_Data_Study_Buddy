...
T = TypeVar("T", bound="SdtmDatasetVariablesLinks")
...
class SdtmDatasetVariablesLinks:
    """
    Attributes:
        self_ (Union[Unset, SdtmDatasetVariablesRef]):
        parent_product (Union[Unset, SdtmProductRef]):
        parent_class (Union[Unset, SdtmClassRef]):
        prior_version (Union[Unset, SdtmDatasetVariablesRef]):
        dataset_variables (Union[Unset, list['SdtmDatasetVariableRefElement']]):
    """

    self_: Union[Unset, "SdtmDatasetVariablesRef"] = UNSET
    parent_product: Union[Unset, "SdtmProductRef"] = UNSET
    parent_class: Union[Unset, "SdtmClassRef"] = UNSET
    prior_version: Union[Unset, "SdtmDatasetVariablesRef"] = UNSET
    dataset_variables: Union[Unset, list["SdtmDatasetVariableRefElement"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmDatasetVariablesRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmDatasetVariablesRef.from_dict(_prior_version)
        ...
        sdtm_dataset_variables_links = cls(
            self_=self_,
        ...
        sdtm_dataset_variables_links.additional_properties = d
        return sdtm_dataset_variables_links
