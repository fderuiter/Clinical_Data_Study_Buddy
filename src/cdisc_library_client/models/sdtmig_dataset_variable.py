...
if TYPE_CHECKING:
    from ..models.sdtmig_dataset_variable_links import SdtmigDatasetVariableLinks


T = TypeVar("T", bound="SdtmigDatasetVariable")
...
class SdtmigDatasetVariable:
    """
    Attributes:
        ordinal (Union[Unset, str]):  Example: 42.
        name (Union[Unset, str]):  Example: LBDTC.
        label (Union[Unset, str]):  Example: Date/Time of Specimen Collection.
        description (Union[Unset, str]):  Example: Date/time of specimen collection represented in ISO 8601 character
            format..
        role (Union[Unset, str]):  Example: Timing.
        simple_datatype (Union[Unset, str]):  Example: Char.
        core (Union[Unset, str]):  Example: Exp.
        described_value_domain (Union[Unset, str]):  Example: ISO 8601.
        value_list (Union[Unset, list[str]]):  Example: TODO.
        field_links (Union[Unset, SdtmigDatasetVariableLinks]):
    """
    ...
    field_links: Union[Unset, "SdtmigDatasetVariableLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmigDatasetVariableLinks.from_dict(_field_links)

        sdtmig_dataset_variable = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        sdtmig_dataset_variable.additional_properties = d
