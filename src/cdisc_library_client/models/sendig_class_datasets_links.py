...
if TYPE_CHECKING:
    from ..models.sendig_class_datasets_ref import SendigClassDatasetsRef
...
T = TypeVar("T", bound="SendigClassDatasetsLinks")
...
class SendigClassDatasetsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SendigClassDatasetsRef.from_dict(_self_)
        ...
        sendig_class_datasets_links = cls(
            self_=self_,
            parent_product=parent_product,
            datasets=datasets,
        )

        sendig_class_datasets_links.additional_properties = d
