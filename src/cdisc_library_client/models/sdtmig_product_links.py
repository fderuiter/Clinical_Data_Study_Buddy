...
T = TypeVar("T", bound="SdtmigProductLinks")
...
class SdtmigProductLinks:
    """
    Attributes:
        self_ (Union[Unset, SdtmigProductRef]):
        model (Union[Unset, SdtmProductRef]):
        prior_version (Union[Unset, SdtmigProductRef]):
    """

    self_: Union[Unset, "SdtmigProductRef"] = UNSET
    model: Union[Unset, "SdtmProductRef"] = UNSET
    prior_version: Union[Unset, "SdtmigProductRef"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmigProductRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmigProductRef.from_dict(_prior_version)

        sdtmig_product_links = cls(
            self_=self_,
            model=model,
            prior_version=prior_version,
        )

        sdtmig_product_links.additional_properties = d
