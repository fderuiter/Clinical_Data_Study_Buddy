...
T = TypeVar("T", bound="ExportCdashigScenarioVariablesRow")
...
class ExportCdashigScenarioVariablesRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_cdashig_scenario_variables_row = cls(
            version=version,
            class_=class_,
            domain=domain,
        ...
        export_cdashig_scenario_variables_row.additional_properties = d
