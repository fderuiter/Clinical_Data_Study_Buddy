...
T = TypeVar("T", bound="AdamDatastructureVarsets")
...
class AdamDatastructureVarsets:
    ...
    Attributes:
        ...
        field_links (Union[Unset, AdamDatastructureVarsetsLinks]):
    """
    ...
    field_links: Union[Unset, "AdamDatastructureVarsetsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = AdamDatastructureVarsetsLinks.from_dict(_field_links)

        adam_datastructure_varsets = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        adam_datastructure_varsets.additional_properties = d
