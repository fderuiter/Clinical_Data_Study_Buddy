...
T = TypeVar("T", bound="CdashigProductScenarios")
...
class CdashigProductScenarios:
    ...
    Attributes:
        ...
        field_links (Union[Unset, CdashigProductScenariosLinks]):
    """
    ...
    field_links: Union[Unset, "CdashigProductScenariosLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashigProductScenariosLinks.from_dict(_field_links)

        cdashig_product_scenarios = cls(
            name=name,
            label=label,
        ...
        cdashig_product_scenarios.additional_properties = d
