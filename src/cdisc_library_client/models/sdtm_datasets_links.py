...
if TYPE_CHECKING:
    ...
    from ..models.sdtm_datasets_ref import SdtmDatasetsRef
    from ..models.sdtm_product_ref import SdtmProductRef


T = TypeVar("T", bound="SdtmDatasetsLinks")
...
class SdtmDatasetsLinks:
    """
    Attributes:
        self_ (Union[Unset, SdtmDatasetsRef]):
        parent_product (Union[Unset, SdtmProductRef]):
        prior_version (Union[Unset, SdtmDatasetsRef]):
        datasets (Union[Unset, list['SdtmDatasetRefElement']]):
    """

    self_: Union[Unset, "SdtmDatasetsRef"] = UNSET
    parent_product: Union[Unset, "SdtmProductRef"] = UNSET
    prior_version: Union[Unset, "SdtmDatasetsRef"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmDatasetsRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmDatasetsRef.from_dict(_prior_version)
        ...
        sdtm_datasets_links.additional_properties = d
