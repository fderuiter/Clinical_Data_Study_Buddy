...
T = TypeVar("T", bound="ExportSdtmDatasetVariablesRow")
...
class ExportSdtmDatasetVariablesRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_sdtm_dataset_variables_row = cls(
            version=version,
        ...
        export_sdtm_dataset_variables_row.additional_properties = d
        return export_sdtm_dataset_variables_row
