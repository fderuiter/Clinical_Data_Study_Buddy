...
if TYPE_CHECKING:
    from ..models.qrs_items_links import QrsItemsLinks


T = TypeVar("T", bound="QrsItems")
...
class QrsItems:
    ...
    Attributes:
        ...
        field_links (Union[Unset, QrsItemsLinks]):
    """
    ...
    field_links: Union[Unset, "QrsItemsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = QrsItemsLinks.from_dict(_field_links)
        ...
        qrs_items.additional_properties = d
        return qrs_items
