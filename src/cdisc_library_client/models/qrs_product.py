...
if TYPE_CHECKING:
    from ..models.qrs_item import QrsItem
    from ..models.qrs_product_links import QrsProductLinks


T = TypeVar("T", bound="QrsProduct")
...
class QrsProduct:
    ...
    Attributes:
        ...
        field_links (Union[Unset, QrsProductLinks]):
        items (Union[Unset, list['QrsItem']]):
    """
    ...
    field_links: Union[Unset, "QrsProductLinks"] = UNSET
    items: Union[Unset, list["QrsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = QrsProductLinks.from_dict(_field_links)

        items = []
        _items = d.pop("items", UNSET)
        for items_item_data in _items or []:
            items_item = QrsItem.from_dict(items_item_data)
        ...
        qrs_product.additional_properties = d
        return qrs_product
