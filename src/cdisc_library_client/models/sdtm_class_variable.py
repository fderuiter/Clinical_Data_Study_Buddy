...
if TYPE_CHECKING:
    from ..models.sdtm_class_variable_links import SdtmClassVariableLinks


T = TypeVar("T", bound="SdtmClassVariable")
...
class SdtmClassVariable:
    """
    Attributes:
        ordinal (Union[Unset, str]):  Example: 26.
        name (Union[Unset, str]):  Example: --DTC.
        label (Union[Unset, str]):  Example: Date/Time of Collection.
        description (Union[Unset, str]):  Example: Collection date and time of an observation..
        role (Union[Unset, str]):  Example: Timing.
        role_description (Union[Unset, str]):  Example: Timing.
        simple_datatype (Union[Unset, str]):  Example: Char.
        described_value_domain (Union[Unset, str]):  Example: ISO 8601.
        field_links (Union[Unset, SdtmClassVariableLinks]):
    """
    ...
    field_links: Union[Unset, "SdtmClassVariableLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmClassVariableLinks.from_dict(_field_links)

        sdtm_class_variable = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        sdtm_class_variable.additional_properties = d
