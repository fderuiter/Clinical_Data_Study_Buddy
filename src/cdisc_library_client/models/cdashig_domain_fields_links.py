...
T = TypeVar("T", bound="CdashigDomainFieldsLinks")
...
class CdashigDomainFieldsLinks:
    """
    Attributes:
        self_ (Union[Unset, CdashigDomainFieldsRef]):
        parent_product (Union[Unset, CdashigProductRef]):
        parent_class (Union[Unset, CdashigClassRef]):
        fields (Union[Unset, list['CdashigDomainFieldRefElement']]):
    """

    self_: Union[Unset, "CdashigDomainFieldsRef"] = UNSET
    parent_product: Union[Unset, "CdashigProductRef"] = UNSET
    parent_class: Union[Unset, "CdashigClassRef"] = UNSET
    fields: Union[Unset, list["CdashigDomainFieldRefElement"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = CdashigDomainFieldsRef.from_dict(_self_)
        ...
        for fields_item_data in _fields or []:
            fields_item = CdashigDomainFieldRefElement.from_dict(fields_item_data)

            fields.append(fields_item)

        cdashig_domain_fields_links = cls(
            self_=self_,
        ...
        cdashig_domain_fields_links.additional_properties = d
