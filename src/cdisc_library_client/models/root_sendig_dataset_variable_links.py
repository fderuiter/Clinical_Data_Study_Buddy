...
class RootSendigDatasetVariableLinks:
    """
    Attributes:
        self_ (Union[Unset, RootSendigDatasetVariableRef]):
        versions (Union[Unset, list['SendigDatasetVariableRefVersion']]):
    """

    self_: Union[Unset, "RootSendigDatasetVariableRef"] = UNSET
    versions: Union[Unset, list["SendigDatasetVariableRefVersion"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = RootSendigDatasetVariableRef.from_dict(_self_)
        ...
        root_sendig_dataset_variable_links = cls(
            self_=self_,
            versions=versions,
        )

        root_sendig_dataset_variable_links.additional_properties = d
