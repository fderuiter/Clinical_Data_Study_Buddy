...
if TYPE_CHECKING:
    ...
    from ..models.sdtmig_datasets_ref import SdtmigDatasetsRef
    from ..models.sdtmig_product_ref import SdtmigProductRef


T = TypeVar("T", bound="SdtmigDatasetsLinks")
...
class SdtmigDatasetsLinks:
    """
    Attributes:
        self_ (Union[Unset, SdtmigDatasetsRef]):
        parent_product (Union[Unset, SdtmigProductRef]):
        prior_version (Union[Unset, SdtmigDatasetsRef]):
        datasets (Union[Unset, list['SdtmigDatasetRefElement']]):
    """

    self_: Union[Unset, "SdtmigDatasetsRef"] = UNSET
    parent_product: Union[Unset, "SdtmigProductRef"] = UNSET
    prior_version: Union[Unset, "SdtmigDatasetsRef"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = SdtmigDatasetsRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = SdtmigDatasetsRef.from_dict(_prior_version)
        ...
        sdtmig_datasets_links.additional_properties = d
        return sdtmig_datasets_links
