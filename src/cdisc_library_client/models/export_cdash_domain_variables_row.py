...
T = TypeVar("T", bound="ExportCdashDomainVariablesRow")
...
class ExportCdashDomainVariablesRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_cdash_domain_variables_row = cls(
            version=version,
            class_=class_,
            domain=domain,
        ...
        export_cdash_domain_variables_row.additional_properties = d
        return export_cdash_domain_variables_row
