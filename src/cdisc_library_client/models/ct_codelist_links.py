...
T = TypeVar("T", bound="CtCodelistLinks")
...
class CtCodelistLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = CtCodelistRef.from_dict(_self_)
        ...
        if isinstance(_prior_version, Unset):
            ...
            prior_version = CtCodelistRef.from_dict(_prior_version)

        ct_codelist_links = cls(
            self_=self_,
        ...
        ct_codelist_links.additional_properties = d
        return ct_codelist_links
