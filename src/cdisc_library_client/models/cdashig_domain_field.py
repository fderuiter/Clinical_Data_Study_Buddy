...
if TYPE_CHECKING:
    from ..models.cdashig_domain_field_links import CdashigDomainFieldLinks


T = TypeVar("T", bound="CdashigDomainField")
...
class CdashigDomainField:
    ...
    Attributes:
        ...
        name (Union[Unset, str]):  Example: VSDAT.
        ...
        question_text (Union[Unset, str]):  Example: What was the date of the vital signs measurement?.
        prompt (Union[Unset, str]):  Example: Date.
        completion_instructions (Union[Unset, str]):  Example: Record date of measurements using this format (DD-MON-
            YYYY)..
        implementation_notes (Union[Unset, str]):  Example: The date of measurement can be determined from a collected
            date of visit (VISDAT) and in such cases a separate measurement date field is not required..
        ...
        field_links (Union[Unset, CdashigDomainFieldLinks]):
    """
    ...
    field_links: Union[Unset, "CdashigDomainFieldLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashigDomainFieldLinks.from_dict(_field_links)

        cdashig_domain_field = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        cdashig_domain_field.additional_properties = d
