...
T = TypeVar("T", bound="ExportSdtmigDatasetsTable")


@_attrs_define
class ExportSdtmigDatasetsTable:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_sdtmig_datasets_table = cls(
            datasets=datasets,
        )

        export_sdtmig_datasets_table.additional_properties = d
