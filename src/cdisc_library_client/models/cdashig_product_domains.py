...
if TYPE_CHECKING:
    from ..models.cdashig_product_domains_links import CdashigProductDomainsLinks


T = TypeVar("T", bound="CdashigProductDomains")
...
class CdashigProductDomains:
    ...
    Attributes:
        ...
        field_links (Union[Unset, CdashigProductDomainsLinks]):
    """
    ...
    field_links: Union[Unset, "CdashigProductDomainsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashigProductDomainsLinks.from_dict(_field_links)

        cdashig_product_domains = cls(
            name=name,
            label=label,
        ...
        cdashig_product_domains.additional_properties = d
