...
T = TypeVar("T", bound="ExportSdtmDatasetsTable")
...
class ExportSdtmDatasetsTable:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_sdtm_datasets_table = cls(
            datasets=datasets,
        )

        export_sdtm_datasets_table.additional_properties = d
        return export_sdtm_datasets_table
