...
if TYPE_CHECKING:
    from ..models.sdtmig_class_links import SdtmigClassLinks
    from ..models.sdtmig_dataset import SdtmigDataset


T = TypeVar("T", bound="SdtmigClass")
...
class SdtmigClass:
    ...
    Attributes:
        ...
        field_links (Union[Unset, SdtmigClassLinks]):
        datasets (Union[Unset, list['SdtmigDataset']]):
    """
    ...
    field_links: Union[Unset, "SdtmigClassLinks"] = UNSET
    datasets: Union[Unset, list["SdtmigDataset"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmigClassLinks.from_dict(_field_links)

        datasets = []
        _datasets = d.pop("datasets", UNSET)
        for datasets_item_data in _datasets or []:
            datasets_item = SdtmigDataset.from_dict(datasets_item_data)
        ...
        sdtmig_class.additional_properties = d
        return sdtmig_class
