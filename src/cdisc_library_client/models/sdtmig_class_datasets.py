...
if TYPE_CHECKING:
    from ..models.sdtmig_class_datasets_links import SdtmigClassDatasetsLinks


T = TypeVar("T", bound="SdtmigClassDatasets")
...
class SdtmigClassDatasets:
    ...
    Attributes:
        ...
        field_links (Union[Unset, SdtmigClassDatasetsLinks]):
    """
    ...
    field_links: Union[Unset, "SdtmigClassDatasetsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = SdtmigClassDatasetsLinks.from_dict(_field_links)

        sdtmig_class_datasets = cls(
            ordinal=ordinal,
            name=name,
            label=label,
        ...
        sdtmig_class_datasets.additional_properties = d
