...
if TYPE_CHECKING:
    from ..models.cdash_product_domains_links import CdashProductDomainsLinks


T = TypeVar("T", bound="CdashProductDomains")


@_attrs_define
class CdashProductDomains:
    """
    Attributes:
        ...
        field_links (Union[Unset, CdashProductDomainsLinks]):
    """
    ...
    field_links: Union[Unset, "CdashProductDomainsLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = CdashProductDomainsLinks.from_dict(_field_links)

        cdash_product_domains = cls(
            name=name,
            label=label,
        ...
        cdash_product_domains.additional_properties = d
