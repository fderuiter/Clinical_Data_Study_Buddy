...
if TYPE_CHECKING:
    ...
    from ..models.cdashig_product_domains_ref import CdashigProductDomainsRef
    from ..models.cdashig_product_ref import CdashigProductRef


T = TypeVar("T", bound="CdashigProductDomainsLinks")
...
class CdashigProductDomainsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_self_, Unset):
            ...
            self_ = CdashigProductDomainsRef.from_dict(_self_)
        ...
        cdashig_product_domains_links = cls(
            self_=self_,
            parent_product=parent_product,
            domains=domains,
        )

        cdashig_product_domains_links.additional_properties = d
        return cdashig_product_domains_links
