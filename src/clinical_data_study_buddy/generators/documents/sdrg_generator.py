...
class SDRGGenerator(BaseDocumentGenerator):
    ...
    def _add_sections(self, document):
        ...
        document.add_paragraph(
            f"This document describes the study data for {self.study_config.study_id}."
        )
        document.add_paragraph(
            "This guide is intended to assist the reviewer in understanding the structure and content of the study data."
        )
        ...
        document.add_paragraph(
            "This section describes how the data was collected and processed."
        )

        # Section 5: SDTM Datasets
        document.add_heading("5. SDTM Datasets", level=1)
        document.add_paragraph(
            "The following SDTM datasets are included in this submission:"
        )
        ...
        document.add_paragraph(
            "The study data were checked for conformance with the CDISC SDTM standard."
        )
        document.add_paragraph(
