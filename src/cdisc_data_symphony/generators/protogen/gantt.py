...
def generate_gantt_chart(tasks, output_path):
    """
    Generates a Gantt chart from a list of tasks.
    ...
    :param output_path: The path to save the Gantt chart image.
    """
    ...
    for i, task in df.iterrows():
        ax.barh(y=task['name'], width=(task['end'] - task['start']), left=task['start'], height=0.5)
